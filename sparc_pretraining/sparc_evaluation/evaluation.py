...
if __name__ == "__main__":
    ...
    parser.add_argument('--gold', dest='gold', default='../dev_gold.txt', type=str)
    parser.add_argument('--pred', dest='pred', default='../sparc_predict/test.txt', type=str)
    parser.add_argument('--db', dest='db', default='/home/fyw/py_projs/unsupervised_text_rewrite/pptod-main/data/text2sql/data/sparc/database', type=str)
    parser.add_argument('--table', dest='table', default='/home/fyw/py_projs/unsupervised_text_rewrite/pptod-main/data/text2sql/data/sparc/tables.json', type=str)
    parser.add_argument('--etype', dest='etype', default='all', type=str)
