...
from process_turn_switch import process_dev as process_dev_turn_switch
from process_tcs_column_table import process_dev as process_dev_col_tab
...
def process_sparc_dev():
    data_dict = reformat("train.json", False)
    ...
    json.dump(data_dict, open('train.json', 'w'), ensure_ascii=False)
